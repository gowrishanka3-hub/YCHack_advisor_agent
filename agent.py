...
SYSTEM_PROMPT = textwrap.dedent(
    ...
    - Before stating any fact about courses, credits, prerequisites, or requirements,
      you MUST call a search tool. Never guess or rely on memory alone.
    - For broad questions, call search_all. For student-specific progress, search
      degree_audit. For a single course or prereqs, search course_registry. For major
      rules or semester plans, search major_requirements.
